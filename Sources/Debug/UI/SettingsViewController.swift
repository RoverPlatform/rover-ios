...
open class SettingsViewController: UIViewController {
    public let testDeviceManager: TestDeviceManager
    ...
    public init(testDeviceManager: TestDeviceManager) {
...
extension SettingsViewController: UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.toggle.isOn = testDeviceManager.isTestDevice
    ...
    @objc func toggleTestDevice(_ sender: Any) {
        ...
        testDeviceManager.isTestDevice = toggle.isOn
    }
