...
class ImageStore {
    ...
    func image(for background: ClassicBackground, frame: CGRect) -> UIImage? {
    ...
    func image(for image: ClassicImage, frame: CGRect) -> UIImage? {
    ...
    func fetchImage(for background: ClassicBackground, frame: CGRect, completionHandler: ((UIImage?) -> Void)? = nil) {
    ...
    /// Before making a network request the image store will first attempt to retreive the image from its cache and will
    /// return the cache result if found.
    func fetchImage(for image: ClassicImage, frame: CGRect, completionHandler: ((UIImage?) -> Void)? = nil) {
        let configuration = Configuration(image: image, frame: frame)
        fetchImage(for: configuration, completionHandler: completionHandler)
    }
...
extension ImageStore.Configuration {
    ...
    init?(background: ClassicBackground, frame: CGRect) {
