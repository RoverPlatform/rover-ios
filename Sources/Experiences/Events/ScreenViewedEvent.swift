...
/// Describes a user's screen view in a Rover experience. A value of this type is given to the registered screen view callback registered with the shared Rover foundation object. Use this to implement the behavior for custom buttons and the like.
///
