...
extension URLRequest {
    ...
    private mutating func addDefaultHeaders() {
        ...
        addValue(roverUserAgent, forHTTPHeaderField: "User-Agent")
    }
...
private var roverUserAgent: String {
    ...
    return "\(appDescriptor) \(cfNetworkDescriptor) \(darwinDescriptor) \(osDescriptor) RoverSDK/\(Meta.SDKVersion)"
}
