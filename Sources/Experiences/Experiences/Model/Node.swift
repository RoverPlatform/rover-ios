...
class Node: Decodable, Identifiable {
    ...
    required init(from decoder: Decoder) throws {
        ...
        // Interaction
        action = try container.decodeIfPresent(ExperienceAction.self, forKey: .action)
