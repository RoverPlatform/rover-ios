...
final class NavBar: Node {
    ...
    public struct Background: Decodable {
        public let fillColor: ColorReference
        public let shadowColor: ColorReference
        public let blurEffect: Bool
        
        public init(fillColor: ColorReference, shadowColor: ColorReference, blurEffect: Bool) {
    ...
    public struct Appearance: Decodable {
        public let titleColor: ColorReference
        public let buttonColor: ColorReference
        public let background: Background
        
        public init(titleColor: ColorReference, buttonColor: ColorReference, background: Background) {
    ...
    public init(id: String = UUID().uuidString, name: String?, parent: Node? = nil, children: [Node] = [], ignoresSafeArea: Set<Edge>? = nil, aspectRatio: CGFloat? = nil, padding: Padding? = nil, frame: Frame? = nil, layoutPriority: CGFloat? = nil, offset: CGPoint? = nil, shadow: Shadow? = nil, opacity: CGFloat? = nil, background: RoverExperiences.Background? = nil, overlay: Overlay? = nil, mask: Node? = nil, action: ExperienceAction? = nil, accessibility: Accessibility? = nil, metadata: Metadata? = nil, title: String, titleDisplayMode: TitleDisplayMode, hidesBackButton: Bool, titleFont: Font, largeTitleFont: Font, buttonFont: Font, appearance: Appearance, alternateAppearance: Appearance?) {
