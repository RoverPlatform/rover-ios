...
public struct NBAGameState: Codable, Hashable {
    /// Current phase of the game
    public var gamePhase: NBAGamePhase

    /// Game clock display string or nil during breaks
    /// Format: "MM:SS" (e.g., "12:00", "05:32", "00:24.5")
    /// nil during halftime or other breaks
    public var clock: String?
    
    /// Time remaining in the current quarter in seconds
    /// Range: 0-720 (12 minutes per quarter, 5 min OT)
    public var timeRemaining: Int
    
    /// Whether our team currently has possession of the ball
    public var inPossession: Bool
    
    /// Current scoring run by our team (consecutive points scored)
    /// Resets when opponent scores
    /// e.g., 8 means our team has scored 8 unanswered points
    public var scoringRun: Int
    ...
    /// true during timeouts, free throws, dead balls
    public var isClockPaused: Bool
    ...
    public init(from decoder: Decoder) throws {
        ...
        gamePhase = try container.decode(NBAGamePhase.self, forKey: .gamePhase)
        ...
        scoringRun = try container.decode(Int.self, forKey: .scoringRun)
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(scoringRun, forKey: .scoringRun)
