...
class InfluenceTrackerService: InfluenceTracker {
    ...
    func startMonitoring() {
        self.didBecomeActiveObserver = notificationCenter.addObserver(
    ...
    func trackInfluencedOpen() {
        ...
        guard let lastReceivedNotification = try? PropertyListDecoder().decode(NotificationReceipt.self, from: data)
        else {
            return
        }
