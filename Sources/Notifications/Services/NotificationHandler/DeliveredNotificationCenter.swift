...
struct DeliveredNotificationCenter {
    var getDeliveredNotifications: () async -> [UNNotification]
    var removeDeliveredNotifications: ([String]) -> Void

    static let live = DeliveredNotificationCenter(
    ...
    static let empty = DeliveredNotificationCenter(
        getDeliveredNotifications: { [] },
