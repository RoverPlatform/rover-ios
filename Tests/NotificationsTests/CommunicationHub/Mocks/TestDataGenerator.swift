...
class TestDataGenerator {
    ...
    // MARK: - Participant Generation

    static func createTestParticipants(count: Int) -> [ParticipantItem] {
    ...
    static func makeConversationItem(
        id: UUID = UUID(),
        subject: String? = nil,
        lastReplyAt: Date? = nil,
        lastIncomingReplyAt: Date? = nil,
        lastIncomingParticipantID: String? = nil,
        lastReadAt: Date? = nil,
