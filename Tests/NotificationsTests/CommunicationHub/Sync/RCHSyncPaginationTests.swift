...
/// Tests for RCHSync cursor-based pagination logic
final class RCHSyncPaginationTests: RCHSyncTestBase {
  ...
  func testEmptyPageHandling() async {
    ...
    // When: Sync is performed
    let result2 = await rchSync.sync()
