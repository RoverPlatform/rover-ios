...
/// Base class for all Communication Hub sync tests
/// Provides common setup, teardown, and helper methods
class RCHSyncTestBase: XCTestCase {

  // MARK: - Test Infrastructure

  var testContainer: RCHPersistentContainer!
  ...
  override func setUp() async throws {
    ...
    testContainer = RCHPersistentContainer(storage: .inMemory)
    ...
    // Create RCHSync with test dependencies
    rchSync = await MainActor.run {
      RCHSync(
